...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.1, maximum-scale=2.0, minimum-scale=1.0">
...
<body>
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-side-scroll">
                ...
                <ul id="menu-list" class="layui-nav layui-nav-tree" lay-shrink="all" lay-filter="test">
                    <li class="layui-nav-item">
                        <a href="./manage_accept.php" target="right">
                            <i class="layui-icon layui-icon-form" style="font-size: 24px;"></i>
                            检测待接受学生名单</a>
                    </li>
                    <li class="layui-nav-item layui-nav-itemed">
                        <a href="./manage_check_student.php" target="right">
                            <i class="layui-icon layui-icon-user" style="font-size: 24px;"></i>
                            检查系统分配学生</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="./manage_s_bc_form.php" target="right">
                            <i class="layui-icon layui-icon-form" style="font-size: 24px;"></i>
                            大改名单</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="./manage_student_state.php" target="right">
                            <i class="layui-icon layui-icon-form" style="font-size: 24px;"></i>
                            学生完成状态</a>
                    </li>
                </ul>
        ...
        <div class="layui-body">
            <iframe scrolling="auto" rameborder="0" src="./manage_accept.php" name="right" width="100%" height="100%"></iframe>
        </div>